...
## Monitoring en typescript

le monitoring a comme but de voir les erreur présente chez les clients 


ce projet a durer 1 mois en entreprise 
![code todo liste rust](monito.png)